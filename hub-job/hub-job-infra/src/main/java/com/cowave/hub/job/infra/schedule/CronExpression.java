...
public final class CronExpression implements Serializable, Cloneable {
    ...
    protected void buildExpression(String expression) throws ParseException {
        ...
        try {
            ...
            boolean dayOfMonth = !dom.contains(NO_SPEC);
            boolean dayOfWeek = !dow.contains(NO_SPEC);
    ...
    public Date getTimeAfter(Date afterTime) {
        ...
        while (!gotOne) {
            ...
            // get day...................................................
            boolean dayOfMonth = !daysOfMonth.contains(NO_SPEC);
            boolean dayOfWeek = !daysOfWeek.contains(NO_SPEC);
            if (dayOfMonth && !dayOfWeek) { // get day by day of month rule
            ...
            } else if (dayOfWeek && !dayOfMonth) { // get day by day of week rule
