...
import com.cowave.hub.meter.core.utils.StringUtil;
...
public class DockerBuild implements AutoCloseable {
    ...
    private final IDockerPlugin plugin;

    public DockerBuild(Map<String, Object> parameter, IDockerPlugin plugin) {
