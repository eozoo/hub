...
window.addEventListener('load', () => {
    ...
    const encodedNick = getCookie("blog-userNick");
    const userName = encodedNick ? decodeBase64Unicode(encodedNick) : null;
    if (!userName) {
    ...
    Eg = {class: "content"}, Mg = {class: "text"}, Lg = zm({
        __name: "Message", setup(e) {
            const t = dm(), n = Vi((() => {
                ...
                return e.split(".")
            })), o = pt({hello: "Hello World !", text: "一个默默无闻的小栈，茫然漂泊在互联网的偏远角落..."}), r = () => {
...
const loadKb = async () => {
    try {
        const resp = await fetch("/auth/icons");
            ...
            en((() => {
                (() => {
                    ...
                    t = e < 6 ? "凌晨好" : e < 9 ? "早上好" : e < 12 ? "上午好" : e < 14 ? "中午好" : e < 17 ? "下午好" : e < 19 ? "傍晚好" : e < 22 ? "晚上好" : "夜深了", xv({
                        ...
                        message: `<strong>${t}</strong> 欢迎来到小栈`
                    })
                })(), (() => {
