...
import com.cowave.hub.admin.app.sys.HubAlarmController;
...
public class HubAlarmControllerTest extends SpringTest {
    ...
    @Autowired
    private HubAlarmController hubAlarmController;

    @BeforeEach
    public void beforeEach() {
        mockMvc = MockMvcBuilders.standaloneSetup(hubAlarmController)
